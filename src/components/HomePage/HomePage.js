                    ...
                    <div className={styles.containerLeft}>
                                    ...
                                    <div>
                                        {
                                           categories.map((values)=>{
                                            return(
                                                <div className={styles.categoryList} onClick={()=>{setFilters({...filters, category:values.category})}}>{values.category}</div>
                                            )
                                           })
                                        }
                                    </div>
                        ...
                        <div className='row mt-3'>
                            <div style={styles.selecteCompany}>
                                ...
                                <select className={`${styles.selectCompany} ${styles.companyList}`} onChange={(e)=>{companySelect(e.target.value)}}>
                                <option className={styles.companyList}>all</option>
                                    { 
                                        companies.map((values)=>{
                                            return(
                                                <option className={styles.companyList} value={values.companyName}>{values.companyName}</option>
                                            )
                                        })
                                    } 
                                </select>
                        ...
                        <div className='row mt-3'>
                            ...
                            <div className={styles.colorSelect}>
                                <div className={styles.colorArea}>
                                    <div className='me-2'><div onClick={()=>{setFilters({...filters, color:''})}} className={styles.colorsAll}>all</div></div>
                                    {/* <div className={styles.colors} style={{backgroundColor: 'blue'}}></div> */}
                                    {
                                        colors.map((values)=>{
                                            return(
                                                <div onClick={()=>{setFilters({...filters, color:values.color})}} className={`${styles.colors} ${styles.colorActive}`} style={{backgroundColor: '#'+values.color}}></div>
                                            )
                                        })
                                    }
                                </div>
